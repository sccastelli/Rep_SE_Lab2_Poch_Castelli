...
static const char *TAG = "cam_histograma";
...
void histogram_equalization(uint8_t *buf, size_t len) {
    ...
    for (size_t i = 0; i < len; i++) buf[i] = lut[buf[i]];
}
